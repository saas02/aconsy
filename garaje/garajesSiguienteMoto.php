...
<body>
    ...
    <p>
		...
		error_reporting(0);
			...
			$Sql1="select lugar_garaje from garaje";
			...
			if($maxid_garaje<$valorid_garaje){
				$valorid_garaje=101;
				}
			$Sql="select id_garaje, lugar_garaje, numero_garaje from garaje where id_garaje='".$valorid_garaje."'";
