        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="http://www.sena.edu.co"><img src="/web-app/img/logo_sena2.png" height="36" width="37" /></a><!--<b><font face="Lucida Console, Monaco, monospace">SENA</font></b>-->
                    <div class="nav-collapse collapse">
                        <p class="navbar-text pull-right">

                            <?php
                            session_start();
                            define('DIRURL', $_SERVER['DOCUMENT_ROOT'] . '/');
                        ...
                        <ul class="nav">
                            ...
                            <!---->
                            <li><a href="/web-app/acerca.php"><i class="icon-flag icon-white"></i>  Acerca de...</a></li>
                            <li><a href="/web-app/contactenos.php"><i class="icon-envelope icon-white"></i>  Cont&aacute;ctenos</a></li>
                        </ul>
                    </div><!--/.nav-collapse -->
                </div>
            </div>
